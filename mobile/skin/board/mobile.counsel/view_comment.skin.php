...
<?
if (count($list) > 0) { echo "<div style=\"margin:20px 0;background:#232021;color:#fff;line-height:2em;font-weight:bold;padding-left:10px\">{$RemailName}에서 <span style=''>답변</span>드립니다.</div>"; }
    ...
    <td width='100%'>
        ...
        <tr>
            <td valign=top>
                ...
                <!-- 코멘트 출력 -->
                <div style='padding:7px 7px 7px 10px; word-break:break-all; overflow:hidden; clear:both; '>
                <?
...
<tr>
	<td colspan="3" style="border-bottom:1px solid #d3d3d3">&nbsp;</td>
</tr>
</table>
<? } ?>
</div>
...
<? if (count($list) == 0) echo '<div style="height:1px;background:#e4e4e4"></div>'; ?>
