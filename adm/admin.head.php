...
<header id="hd">
    ...
    <nav id="gnb" class="gnb_large <?php echo $adm_menu_cookie['gnb']; ?>">
        ...
        <ul class="gnb_ul">
            <li class="gnb_li on">
                <button type="button" class="btn_op menu-800 menu-order-1" title="환경설정">환경설정</button>
                <div class="gnb_oparea_wr">
                    <div class="gnb_oparea">
                        <h3>고객지원팀</h3>
                        <ul>
	                        <li data-menu="800100"><a href="/adm/bbs/board.php?bo_table=notice" class="gnb_2da  "> 공지사항</a></li>
	                        <li data-menu="800200"><a href="/adm/bbs/board.php?bo_table=before_after" class="gnb_2da  "> 전후사진</a></li>
	                        <li data-menu="800300"><a href="/adm/bbs/board.php?bo_table=real_story" class="gnb_2da  "> 리얼스토리</a></li>
