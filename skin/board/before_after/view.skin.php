...
<tr>
	<td colspan="4" class="viewContentTD">
        ...
        <!-- 내용 출력 -->
        <span id="writeContents"><?php echo get_view_thumbnail($view['content']); ?></span>
...
?>
	...
	<div class="btn-box">
		<a href="<?=$list_href?>" class="write-btn">List</a>
		<? if ($update_href) echo "<a href=\"{$write_href}\" class=\"write-btn\">Modify</a> "; ?>
		<? if ($delete_href) echo "<a href=\"{$delete_href}\" class=\"write-btn\">Delete</a>"; ?>
	</div>
</div>
