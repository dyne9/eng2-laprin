...
<?
if (count($list) > 0) { echo "<div style=\"margin:20px 0;background:#341B3B;color:#fff;line-height:42px;font-weight:bold;padding-left:10px\">답변</div>"; }
...
<tr>
    ...
    <td width='100%'>
        ...
        <tr>
            <td valign=top>
                <!-- 코멘트 출력 -->
                <div style='line-height:20px; padding:7px 7px 30px 10px; word-break:break-all; overflow:hidden; clear:both; '>
                <?
...
<tr>
	<td colspan="2" style="border-top: 1px solid #919191;height:1px"></td>
</tr>
</table>
<? } ?>
</div>
