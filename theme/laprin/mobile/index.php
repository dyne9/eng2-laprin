...
<div id="slider1">
	<div class="owl-carousel">
		<div class="item"><a href="/page.php?pageIndex=150103"><img src="<?php echo G5_THEME_URL;?>/img/mobile/index/slider1-1.jpg" alt=""></a></div>
		<div class="item"><a href="/page.php?pageIndex=140101"><img src="<?php echo G5_THEME_URL;?>/img/mobile/index/slider1-2.jpg" alt=""></a></div>
	</div>
</div>

<div id="sec2" class="w94" style="margin-top:30px;margin-bottom:30px">
	<div class="a-split a-split3-2">
		<img src="<?php echo G5_THEME_URL;?>/img/mobile/index/sec2.png" alt="" class="w100">
	...
	<div class="">
		...
		<div class="owl-carousel">
			<div class="item" data-index="1">
				<a href="/page.php?pageIndex=110101"><img src="<?php echo G5_THEME_URL;?>/img/mobile/index/sec3-1.jpg" class="w100" alt=""></a>
...
<div id="sec4" class="w94">
	<div class="owl-carousel">
		<div class="item">
			<img src="<?php echo G5_THEME_URL;?>/img/mobile/index/sec4-1.jpg" alt="" class="w100">
			<h5>WHY LaPrin</h5>
		...
		<div class="item">
			<img src="<?php echo G5_THEME_URL;?>/img/mobile/index/sec4-2.jpg" alt="" class="w100">
			<h5>WHY LaPrin</h5>
		...
		<div class="item">
			<img src="<?php echo G5_THEME_URL;?>/img/mobile/index/sec4-3.jpg" alt="" class="w100">
			<h5>WHY LaPrin</h5>
...
<div id="sec5" class="w94">
	...
	<div id="sec5-1" class="sub on">
		<img src="<?php echo G5_THEME_URL;?>/img/mobile/index/sec5-1.jpg" alt="" class="w100" usemap="#map1">
		<map name="map1">
	...
	<div id="sec5-2" class="sub">
		<img src="<?php echo G5_THEME_URL;?>/img/mobile/index/sec5-2.jpg" alt="" class="w100" usemap="#map2">
		<map name="map2">
...
<div id="sec6" class="w94">
	<img src="<?php echo G5_THEME_URL;?>/img/mobile/index/sec6.png" alt="" class="w100">
</div>
